...
import type { MemModelEntry, MemProjection, MemStatus } from '@deepseek-ai/dsh-simplemem/client'
...
export interface MemActions extends MemStatsActions {
  ...
  warmup(): Promise<RemoteResult<import('@deepseek-ai/dsh-simplemem/client').MemWarmupResponse>>
  reembed(): Promise<RemoteResult<import('@deepseek-ai/dsh-simplemem/client').MemReembedResponse>>
  downloadModel(model: string): Promise<RemoteResult<import('@deepseek-ai/dsh-simplemem/client').MemDownloadResponse>>
  cancelDownload(): Promise<RemoteResult<import('@deepseek-ai/dsh-simplemem/client').MemCancelDownloadResponse>>
